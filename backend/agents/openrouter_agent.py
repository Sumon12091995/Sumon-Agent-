...
class OpenRouterAgent:
    ...
    def generate_response(self, prompt, context="", debate_context=None):
        ...
        try:
            headers = {
                ...
                "HTTP-Referer": "https://ai-debate-agent.onrender.com",
                "X-Title": "AI Debate Agent"
            }

            system_msg = "You are a rigorous, honest AI debate participant. Be concise, cite specifics, and never invent facts."
    ...
    def get_status(self):
        return {
            ...
            "free_tier": "Free model pool, ~20 RPM",
            "provider": "OpenRouter"
        }
